...
For this project, you may use any AI tools or models you like for code generation, as long as you document your usage (for example, Aider, Gemini, CoPilot, etc.).
...
- `ai.md` - completed with your responses
